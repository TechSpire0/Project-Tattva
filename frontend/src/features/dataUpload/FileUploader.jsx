...
const ACCEPTED_FORMATS =
  ".csv,.json,.xls,.xlsx,application/vnd.ms-excel,application/vnd.openxmlformats-officedocument.spreadsheetml.sheet";
    ...
    <div className="bg-white p-6 rounded-lg shadow-md">
      ...
      >
        ...
        <label htmlFor="file-upload" className="cursor-pointer">
          ...
          <p className="text-xs text-gray-400 mt-1">
            CSV, JSON, XLS, or XLSX files only.
          </p>
        </label>
      </div>
      ...
      {uploadSuccess && (
        <div className="mt-4 p-3 bg-green-100 text-green-800 border border-green-200 rounded-md text-sm animate-fade-in">
          <p>
            <strong>Success!</strong> Your file has been uploaded and is being
            processed.
          </p>
        </div>
      )}
