...
const Brain = (props) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M12 5a3 3 0 0 0-3-3 3 3 0 0 0-3 3v14a3 3 0 0 0 3 3 3 3 0 0 0 3-3V5Z" />
    <path d="M15 7a3 3 0 0 1 3-3 3 3 0 0 1 3 3v14a3 3 0 0 1-3 3 3 3 0 0 1-3-3V7Z" />
    <path d="M12 5h3" />
    <path d="M12 19h3" />
    <path d="M12 12h3" />
  </svg>
...
const Sparkles = (props) => (
  <svg
    ...
    strokeLinejoin="round"
  >
    <path d="M9.91 7.21l1.58 3.19a.25.25 0 0 0 .22.12h3.46a.25.25 0 0 1 .19.41l-2.8 2.74a.25.25 0 0 0-.07.27l.67 3.86a.25.25 0 0 1-.36.27l-3.21-1.7a.25.25 0 0 0-.25 0l-3.21 1.7a.25.25 0 0 1-.36-.27l.67-3.86a.25.25 0 0 0-.07-.27l-2.8-2.74a.25.25 0 0 1 .19-.41h3.46a.25.25 0 0 0 .22-.12l1.58-3.19a.25.25 0 0 1 .44 0Z" />
  </svg>
);
...
const Button = ({ onClick, className = "", children, variant = null }) => (
  <button
    onClick={onClick}
      ...
      <section className="relative overflow-hidden">
        ...
        <div className="relative grid lg:grid-cols-2 gap-12 items-center p-8 lg:p-12">
          ...
          <div className="space-y-6">
            ...
            <h1 className="text-4xl lg:text-4xl font-extrabold text-white leading-tight">
              TATTVA -{" "}
            ...
            <p className="text-lg text-gray-300 leading-relaxed">
              Project TATTVA revolutionizes marine research by combining
              advanced AI algorithms with comprehensive ocean data analysis.
              Discover patterns, identify species, and unlock insights from the
              world's oceans.
            </p>

            <div className="flex space-x-4">
              <Link to="/dashboard">
                <Button className="inline-flex items-center bg-gradient-to-r from-purple-500 to-pink-500 hover:from-purple-600 hover:to-pink-600 text-white px-6 py-3 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105">
      ...
      <section className="space-y-8">
        <div className="text-center space-y-4">
          ...
          <p className="text-lg text-gray-300 max-w-2xl mx-auto">
            Comprehensive tools for marine data analysis and species
            identification
          </p>
        </div>
              ...
              <Link key={index} to={feature.path}>
                <Card className="bg-gray-800/60 backdrop-blur-sm border border-gray-700/50 group hover:border-gray-600/70 transition-all duration-300 hover:scale-105">
                  <CardHeader className="text-center space-y-4">
                    <div
                      className={`w-16 h-16 mx-auto rounded-xl bg-gradient-to-r ${feature.color} flex items-center justify-center group-hover:scale-110 transition-transform duration-300`}
                    >
