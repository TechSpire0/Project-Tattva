...
function InsightsPanel() {
  ...
  return (
    <div className="bg-gray-800/60 backdrop-blur-sm p-3 rounded-xl shadow-lg border border-gray-700/50">
      {/* Header with Lightbulb icon and Chatbot button */}
      ...
      {hypothesisData ? (
        <div className="animate-fade-in">
          <p className="text-sm text-purple-300 italic leading-snug">
