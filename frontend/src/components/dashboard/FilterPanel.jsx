...
const DUMMY_SIGHTINGS_DATA = [
  {
    sighting_id: "STATIC-001",
    latitude: 15.3,
    longitude: 74.12,
    sighting_date: "2024-07-15T10:00:00Z",
    species_id: 1,
    species: { id: 1, common_name: "Indian Mackerel" },
    sea_surface_temp_c: 29.1,
  },
  {
    sighting_id: "STATIC-002",
    latitude: 12.97,
    longitude: 77.59,
    sighting_date: "2024-07-15T11:00:00Z",
    species_id: 2,
    species: { id: 2, common_name: "Indian Oil Sardine" },
    sea_surface_temp_c: 28.5,
  },
  {
    sighting_id: "STATIC-003",
    latitude: 18.92,
    longitude: 72.83,
    sighting_date: "2024-07-16T09:30:00Z",
    species_id: 1,
    species: { id: 1, common_name: "Indian Mackerel" },
    sea_surface_temp_c: 29.3,
  },
  {
    sighting_id: "STATIC-004",
    latitude: 8.48,
    longitude: 76.95,
    sighting_date: "2024-07-16T14:00:00Z",
    species_id: 3,
    species: { id: 3, common_name: "Indo-Pacific King Mackerel" },
    sea_surface_temp_c: 30.1,
  },
  {
    sighting_id: "STATIC-005",
    latitude: 22.57,
    longitude: 88.36,
    sighting_date: "2024-07-15T16:00:00Z",
    species_id: 4,
    species: { id: 4, common_name: "Barramundi (Asian Sea Bass)" },
    sea_surface_temp_c: 29.8,
  },
  {
    sighting_id: "STATIC-006",
    latitude: 15.35,
    longitude: 74.15,
    sighting_date: "2024-07-15T12:00:00Z",
    species_id: 1,
    species: { id: 1, common_name: "Indian Mackerel" },
